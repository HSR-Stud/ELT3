...
und sind immer geschlossen.\\ 
	...
	\begin{tabular}[c]{ | p{5cm} | p{8.7cm} | p{4cm} | }
		...
		\parbox{3cm}{\tiny{$\vec{E}_i$ entgegen $\vec{l}$\\
...
%TODO Selbstindukion S. 5-60

%TODO Gleich- und gegensinnige Kopplung S.5-62/63

%TODO Klemmenspannung bei Belastung S.5-59
...
\parbox{9.5cm}{
		...
		\vspace{.2cm}
	  		...
	  		\textbf{Idealer Trafo}\\ 
	  		\fbox{$"u = \dfrac{u_1}{u_2} = \dfrac{N_1}{N_2} = \sqrt{\dfrac{L_1}{L_2}}$} $\qquad$ (im Leerlauf: $\dfrac{1}{"u} = k \sqrt{\dfrac{L_2}{L_1}}$)
	  		}
  		& \parbox{5cm}{
