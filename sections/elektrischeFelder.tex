...
\begin{tabular}{|p{5cm}|l|l|l|l|l|}
  ...
  \includegraphics[width=3cm]{./images/kreisfoermige_schleife.png} & & & & & \\
  \hline
  ...
  \includegraphics[width=3cm]{./images/kreisrahmenspule.png} & & & & & \\
  \hline
  ...
  \includegraphics[width=3cm]{./images/zylinderspule.png} & & & & & \\
  \hline
  ...
  N^2$\\
  \includegraphics[width=4cm]{./images/toroidspule.png} & & & & & \\
  \hline
  ...
  \includegraphics[width=3cm]{./images/e-c-koaxialkabel.png} & & & & & \\
  \hline
  ...
  \includegraphics[width=3cm]{./images/e-c-paralleldraht.png} & & & & & \\
  \hline
\end{tabular}
